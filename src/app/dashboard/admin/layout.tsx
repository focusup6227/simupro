...
function AdminAuthWrapper({ children }: { children: React.ReactNode }) {
  ...
  if (isLoading) {
    return <div className="p-8">Verifying admin permissions...</div>;
  }
     ...
     return (
        <div className="p-8">
            <Alert variant="destructive">
                ...
                <AlertDescription>
                    Could not verify your permissions due to a database error. If you are an admin and this issue persists,
  ...
  const isAuthorized = isAdminUser(userData);
