...
// SimuPro Admin Layout — restyled access-denied / loading / error states.
// Functionality preserved 1:1: useUser + useDashboardProfile, isAdminUser
// gate, auto-redirect to /dashboard in 3s, error pre-formatted in mono panel.
...
function AdminAuthWrapper({ children }: { children: React.ReactNode }) {
        ...
        >
          ...
          <div className="relative z-10 min-w-0">
            ...
            <p className="text-[12.5px] text-[var(--text-mute)] mt-1 leading-relaxed">
              ...
              are an admin and this issue persists, verify Supabase Row Level
  ...
  if (!isAdminUser(userData)) return <AccessDenied />;
  return <>{children}</>;
}
