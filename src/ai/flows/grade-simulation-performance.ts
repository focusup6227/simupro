...
2.  **Calculate Assessment Score (0-100):** This score reflects how well the user assessed the patient.
...
3.  **Calculate Treatment Score (0-100):** This score reflects the appropriateness and timeliness of treatments.
...
4.  **Provide Reasoning:** Briefly explain the scores. Mention specific mandatory actions the user missed or critical failures they committed.
