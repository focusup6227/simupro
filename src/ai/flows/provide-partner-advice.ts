...
- For arrest, brady, or tachy management when the scenario does not specify doses, align oral coaching with **AHA Guidelines for CPR and ECC (2025)** ACLS patterns (e.g., epinephrine timing in arrest, shock vs no-shock rhythms)—without overriding explicit scenario instructions.
